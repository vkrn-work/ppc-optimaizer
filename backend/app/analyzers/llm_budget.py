...
PROVIDER_LIMITS = {
    # Groq free/on_demand: TPM 12000 на всё. Фикс. промпт ~4200, оставляем
    # 3200 на данные и 4000 на ответ => ~11400, запас ~600.
    "groq":       {"input_budget": 3200,  "max_output": 4000},
...
def est_tokens(text: str) -> int:
    """Грубая оценка токенов. Для русского текста и JSON ~3 символа на токен —
    намеренно пессимистично: лучше недоиспользовать лимит, чем словить 413."""
    return len(text) // 3 + 1
