...
-- hypotheses: нейтральный вердикт (добавить в enum если postgres не поддерживает изменение enum динамически)
-- В PostgreSQL добавление значения в enum требует отдельной команды:
